...
<html lang="en">
  ...
  <div class="block-31" style="position: relative;">
    <div class="owl-carousel loop-block-31 ">
      <div class="block-30 block-30-sm item" style="background-image: url('images/infaq.jpg');" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center">
              <h2 class="heading">Infaq</h2>
              <p class="lead">Hartamu adalah sebagian harta dari mereka, berbagi itu indah.</p>
              <p><a href="#" class="btn btn-primary btn-hover-white py-3 px-5">Infaq Sekarang</a></p>
            </div>
          </div>
        </div>
      </div>
